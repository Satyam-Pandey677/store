...
import {
  saveShippingAdrress,
  savePaymentMethod,
} from "../../redux/features/cart/carSlice";
...
const Shipping = () => {
  ...
  const submitHandler = (e) => {
      ...
      dispatch(saveShippingAdrress({address, city, postalCode, country}));
  ...
  return (
    <div className="container mx-auto mt-10">
      <ProgessSteps step1 step2/>
      <div className="mt-[10rem] flex justify-around items-center flex-wrap">
        <form className="w-[40rem]" onSubmit={submitHandler}>
          <h1 className="h1 text-2xl font-semibold mb-4">Shipping</h1>
          <div className="mb-4">
